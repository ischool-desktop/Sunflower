...
namespace 個人學期成績單
{
    public partial class PersonalSemesterScoreReportForm : BaseForm
    {
        public PersonalSemesterScoreReportForm()
        {
            InitializeComponent();
        }
        ...
        private void PersonalSemesterScoreReportForm_Load(object sender, EventArgs e)
        {

            comboBoxEx1.Items.Add(int.Parse(K12.Data.School.DefaultSchoolYear) - 3);
            comboBoxEx1.Items.Add(int.Parse(K12.Data.School.DefaultSchoolYear) - 2);
            ...
            if(K12.Data.School.DefaultSemester =="1"){
                comboBoxEx2.Items.Add(int.Parse(K12.Data.School.DefaultSemester));
                comboBoxEx2.Items.Add(int.Parse(K12.Data.School.DefaultSemester)+1);
            }
            ...
            comboBoxEx3.Items.Add("1");
            comboBoxEx3.Items.Add("2");
            comboBoxEx3.Items.Add("3");
            comboBoxEx3.Items.Add("4");
        ...
        public void Program_Click()
        {
            ...
            int school_year = int.Parse(comboBoxEx1.Text);

            int semester = int.Parse(comboBoxEx2.Text);

            int rank_sequence = int.Parse(comboBoxEx3.Text);
